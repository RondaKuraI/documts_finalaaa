                                        ...
                                        <tbody>
                                            ...
                                            <?php else : ?>
                                                <?php foreach ($uploads as $row) : ?>
                                                    <tr>
                                                        <td class="d-none d-md-table-cell text-dark"><?= $row['doc_code'] ?></td>
                                                        <td class="text-dark"><strong><?= $row['recipient'] ?></strong> - <small class="text-primary"><?= $row['brgy'] ?></small></td>
                                                        <td>
                                                            <div class="d-md-none mb-1">
                                                                <small class="text-muted"><?= $row['doc_code'] ?></small>
                                                            </div>
                                                            <div>
                                                                <strong class="text-dark"><?= $row['subject'] ?></strong><br>
                                                                <?= $row['description'] ?>
                                                            </div>
                                                        ...
                                                        <td class="d-none d-lg-table-cell text-dark"><?= date('M d, Y', strtotime($row['date_of_letter'])) ?></td>
                                                        <td>
